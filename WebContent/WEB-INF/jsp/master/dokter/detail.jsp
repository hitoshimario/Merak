		...
		<fieldset>
			<legend>Detail Dokter</legend>
				<div class="control-group">
					...
					<div class="controls">
						  <input type="text" id="id" name="id" value="${dokter.id}" readonly="readonly" />
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">Nip Dokter</label>
					<div class="controls">
						  <input type="text" id="nipDokter" name="nipDokter" value="${dokter.nipDokter}" readonly="readonly" />
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">Nama Awal</label>
					<div class="controls">
						  <input type="text" id="namaAwal" name="namaAwal" value="${dokter.namaAwal}" />
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">Nama Akhir</label>
					<div class="controls">
						  <input type="text" id="namaAkhir" name="namaAkhir" value="${dokter.namaAkhir}" />
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">Jenis Kelamin</label>
					<div class="controls">
						  <input type="radio" id="jnsKelamin" name="jnsKelamin" value="0" ${dokter.jnsKelamin == 0 ? 'checked' : ''} />Laki-laki
						  <input type="radio" id="jnsKelamin" name="jnsKelamin" value="1" ${dokter.jnsKelamin == 1 ? 'checked' : ''} />Perempuan
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">Tempat Lahir</label>
					<div class="controls">
						  <input type="text" id="tmpLahir" name="tmpLahir" value="${dokter.tmpLahir}" />
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">Tanggal Lahir</label>
					<div class="controls">
						  <input type="text" id="tglLahir" name="tglLahir" value="${dokter.tglLahir}" />
					</div>
				</div>
				<div class="control-group">
				...
				<div class="control-group">
					...
					<div class="controls">
						  <input type="text" id="telepon" name="telepon" value="${dokter.telepon}" />
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">Email</label>
					<div class="controls">
						  <input type="text" id="email" name="email" value="${dokter.email}" />
					</div>
				</div>
				<div class="control-group">
					<div class="controls">
						<button class="btn btn-small" type="submit">Update Dokter</button>
					</div>
				</div>
		</fieldset>
	</form>
