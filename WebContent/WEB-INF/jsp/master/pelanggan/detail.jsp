		...
		<fieldset>
			<legend>Detail Pelanggan</legend>
				<div class="control-group">
					...
					<div class="controls">
						  <input type="text" id="id" name="id" value="${pelanggan.id}" readonly="readonly" />
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">Nomor Pelanggan</label>
				...
				<div class="control-group">
					...
					<div class="controls">
						  <input type="text" id="namaAwal" name="namaAwal" value="${pelanggan.namaAwal}" />
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">Nama Akhir</label>
					<div class="controls">
						  <input type="text" id="namaAkhir" name="namaAkhir" value="${pelanggan.namaAkhir}" />
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">Jenis Kelamin</label>
					<div class="controls">
						  <input type="radio" id="jnsKelamin" name="jnsKelamin" value="0" ${pelanggan.jnsKelamin == 0 ? 'checked' : ''} />Laki-laki
						  <input type="radio" id="jnsKelamin" name="jnsKelamin" value="1" ${pelanggan.jnsKelamin == 1 ? 'checked' : ''} />Perempuan
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">Tempat Lahir</label>
					<div class="controls">
						  <input type="text" id="tmpLahir" name="tmpLahir" value="${pelanggan.tmpLahir}" />
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">Tanggal Lahir</label>
					<div class="controls">
						  <input type="text" id="tglLahir" name="tglLahir" value="${pelanggan.tglLahir}" />
					</div>
				</div>
				<div class="control-group">
				...
				<div class="control-group">
					...
					<div class="controls">
						  <input type="text" id="telepon" name="telepon" value="${pelanggan.telepon}" />
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">Email</label>
					<div class="controls">
						  <input type="text" id="email" name="email" value="${pelanggan.email}" />
					</div>
				</div>
				<div class="control-group">
					<div class="controls">
						<button class="btn btn-small" type="submit">Update Pelanggan</button>
					</div>
				</div>
		</fieldset>
	</form>
